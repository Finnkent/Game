...
with TelegramClient(sesi_file, api_id, api_hash) as client:
    client.loop.run_until_complete(client.send_message(1492059055 , lanjut))
    ...
    async def handle_chat(event):
        ...
        if "Permainan sudah dimulai..." in pesan:
            time.sleep(3)
            await client.send_message(1492059055,lanjut)
    ...
    @client.on(events.NewMessage(chats=1492059055))
